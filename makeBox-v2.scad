...
wallThickness = 2; 
showlidx=false;
makeEverything(74, 84, 55, padx=16, pady=16, wall=wallThickness, extx=0, exty=70, extendBase=wallThickness, extendSide=0,showlid=showlidx);
makeInky(); 
...
module makeInky() {
// 87 x 38.7 x 9.7
     translate([55,0,0]) rotate([0,0,90]) union() {
